...
local colors = require("glovebox.colors")
...
function M.setup(config)
  ...
  theme.base = {
    ...
    Title = { fg = c.orange, style = "bold" }, -- titles for output from ":set all", ":autocmd" etc.
    ...
    Keyword = { fg = c.redorange, style = config.keywordStyle }, --  any other keyword
  ...
  theme.plugins = {
    ...
    TSVariableBuiltin = { fg = c.orange }, -- Variable names that are defined by the languages, like `this` or `self`.
    ...
    NvimTreeFolderName = { fg = c.vomitgreen },
    ...
    CmpItemAbbrMatch = { fg = c.blue7, bg = c.none },
    CmpItemAbbrMatchFuzzy = { fg = c.blue7, bg = c.none },
