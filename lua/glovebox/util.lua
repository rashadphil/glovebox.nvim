local hsluv = require("glovebox.hsluv")
...
-- local ns = vim.api.nvim_create_namespace("glovebox")
...
function util.debug(colors)
  colors = colors or require("glovebox.colors")
  -- Dump unused colors
...
function util.onColorScheme()
  if vim.g.colors_name ~= "glovebox" then
...
function util.autocmds(config)
  vim.cmd([[augroup TokyoNight]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorScheme * lua require("glovebox.util").onColorScheme()]])
  if config.dev then
    vim.cmd([[  autocmd BufWritePost */lua/glovebox/** nested colorscheme glovebox]])
  end
